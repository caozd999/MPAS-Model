...
parser.add_argument("--no_build_1km_mesh", dest="no_build_1km_mesh",
                    help="If set, build_1km_mesh case will not be run during "
                         "execution of this script.",
                    action="store_true")
parser.add_argument("--finalize_build_1km_mesh", dest="finalize_build_1km_mesh",
                    help="If set, build_1km_mesh case will have symlinks replaced "
...
if not args.no_build_1km_mesh:
    os.chdir(base_path)
    os.chdir('build_1km_mesh')

    print(" * Running build_1km_mesh")
    # Run command is:
    # ./run.py
...
if error:
    sys.exit(1)
if args.finalize_build_1km_mesh:
    old_dir = os.getcwd()
    os.chdir("build_1km_mesh")
    file_list = glob.glob("*")
