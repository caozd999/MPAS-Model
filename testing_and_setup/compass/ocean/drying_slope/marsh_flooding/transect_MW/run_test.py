...
parser.add_argument("--finalize_forward4", dest="finalize_forward4",
                    help="If set, forward4 case will have symlinks replaced "
                         ...
                         "case runs that have been requested.",
                    action="store_true")
parser.add_argument("--no_init_step5", dest="no_init_step5",
                    help="If set, init_step5 case will not be run during "
                         "execution of this script.",
                    action="store_true")
parser.add_argument("--finalize_init_step5", dest="finalize_init_step5",
                    help="If set, init_step5 case will have symlinks replaced "
                         "with the files they point to, this occurs after any "
                         "case runs that have been requested.",
                    action="store_true")
parser.add_argument("--no_forward5", dest="no_forward5",
                    help="If set, forward5 case will not be run during "
                         "execution of this script.",
                    action="store_true")
parser.add_argument("--finalize_forward5", dest="finalize_forward5",
                    help="If set, forward5 case will have symlinks replaced "
                         "with the files they point to, this occurs after any "
                         "case runs that have been requested.",
                    action="store_true")
...
if not args.no_forward4:
    ...
    subprocess.check_call(['./run.py'], stdout=dev_null, stderr=None)
    print("     Complete")
if not args.no_init_step5:
    os.chdir(base_path)
    os.chdir('init_step5')

    print(" * Running init_step5")
    # Run command is:
    # ./run.py
    subprocess.check_call(['./run.py'], stdout=dev_null, stderr=None)
    print("     Complete")
if not args.no_forward5:
    os.chdir(base_path)
    os.chdir('forward5')

    print(" * Running forward5")
    # Run command is:
    # ./run.py
    subprocess.check_call(['./run.py'], stdout=dev_null, stderr=None)
    print("     Complete")
